...
+ [健保住院案件分類](CodeSystem-nhi-inpatient-case-type.html)
+ [醫令類別](CodeSystem-OrderType-cs.html)
+ [給付類別](CodeSystem-PaymentCategory-cs.html)
+ [就醫身分別](CodeSystem-nhi-identity-type.html)
...
+ [醫令類別](ValueSet-OrderType-vs.html)
+ [給付類別](ValueSet-PaymentCategory-vs.html)
+ [就醫身分別](ValueSet-nhi-identity-type.html)
...
+ 完整資訊可參閱[FHIR Known Identifier Systems](https://hl7.org/fhir/identifier-registry.html)規範
