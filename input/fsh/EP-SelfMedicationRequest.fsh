...
Profile: MedicationRequestSelfEMPD
Parent: MedicationRequest
Id: MedicationRequest-Self-EMPD
...
* medication[x] only Reference($Medication-Self-EMPD)
* insurance 1.. MS
...
Instance: med-req-self-01-ep
InstanceOf: MedicationRequestSelfEMPD
Title: "電子處方箋-處方內容-無健保代碼及特殊材料"
Description: "電子處方箋-處方內容(MedicationRequest)特殊材料範例"
Usage: #example
* meta.profile = "https://nhicore.nhi.gov.tw/empd/StructureDefinition/MedicationRequest-Self-EMPD"
* identifier[0]
...
* status = #active
* intent = #order
* medicationReference = Reference(MedicationSelfEMPD-non02)
